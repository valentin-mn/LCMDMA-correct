    ...
    >
      ...
      <v-toolbar-items v-if="$store.state.user">
        ...
        <v-menu offset-y v-if="$store.state.user.userRole == 3">
          ...
          <v-list>
            <router-link to="/admin/" class="toolbar-item"><v-btn text> Accueil Administrateur</v-btn></router-link>
            <br>
            <router-link to="/admin/prestataires" class="toolbar-item"><v-btn text> Gestion Prestataires</v-btn></router-link>
            <br>
            <router-link to="/admin/scan" class="toolbar-item"><v-btn text> Scan des billets</v-btn></router-link>
          </v-list>
        </v-menu>
        <v-menu offset-y v-if="$store.state.user.userRole == 2">
          ...
          <v-list class="text-center">
            <router-link to="/prestataire/home" class="toolbar-item"><v-btn text> Gestion Prestataires</v-btn></router-link>
            <br>
            <router-link to="/prestataire/editer" class="toolbar-item"><v-btn text> Modifier ma page Prestataire</v-btn></router-link>
          </v-list>
        </v-menu>

        <router-link to="/login" class="toolbar-item"><v-btn text @click="logout"> Déconnexion</v-btn></router-link>
      </v-toolbar-items>
      ...
      <v-toolbar-items v-else>
        ...
        <router-link to="/billeterie" class="toolbar-item"><v-btn text> Billetterie</v-btn></router-link>
        <router-link to="/login" class="toolbar-item"><v-btn text> Connexion / Inscription</v-btn></router-link>
      </v-toolbar-items>
    </v-app-bar>
  </div>
</template>
