      ...
      <div class="row">
        <div class="mx-auto col-md-6">
          <h1 class="text-center" style="color: white;">Billetterie</h1>
            <table class="table-tarifaire mx-auto">
              <tr>
                <td></td>
          ...
          <br>
          <message-non-connecte-component class="message-connection" v-if="user == undefined">
            Veuillez vous connecter pour acheter vos billets
          </message-non-connecte-component>
